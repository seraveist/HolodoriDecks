...
const UI = Object.freeze({
  ko: {
    ...
    "calculation.unit": "유닛",
    "calculation.expected": "악곡 기대",
    "calculation.maximum": "악곡 최대",
    "calculation.score": "스코어",
    "calculation.songSettings": "악곡 조건",
    "target.score": "최고 스코어",
    ...
    "play.auto": "AUTO 플레이",
    "play.manual": "수동 ALL PERFECT",
    "calculate.button": "추천 편성 계산",
    "result.title": "결과 계산",
    "result.initial": "추천 편성 계산 버튼을 누르면 선택한 목표의 추천 편성 TOP 5가 표시됩니다.",
    ...
    "preset.conflict": "리더와 같은 홀로멤이 멤버에 고정되어 있습니다.",
  ...
  en: {
    ...
    "calculation.expected": "Expected Song",
    "calculation.maximum": "Maximum Song",
    "calculation.score": "Score",
    "calculation.songSettings": "Song Conditions",
    ...
    "preset.separate": "Exclude Leader from Members",
    ...
    "music.title": "Calculation Settings",
    "music.name": "Song",
    ...
    "play.auto": "AUTO Play",
    "play.manual": "Manual ALL PERFECT",
    "calculate.button": "Calculate Recommended Decks",
    "result.title": "Results",
    "result.initial": "Calculate to show the TOP 5 recommended decks for the selected goal.",
    ...
    "preset.conflict": "A member uses the same character as the locked leader.",
  ...
  ja: {
    ...
    "calculation.expected": "楽曲期待",
    "calculation.maximum": "楽曲最大",
    "calculation.score": "スコア",
    "calculation.songSettings": "楽曲条件",
    "target.score": "最高スコア",
    ...
    "play.auto": "AUTOプレイ",
    "play.manual": "手動 ALL PERFECT",
    "calculate.button": "おすすめ編成を計算",
    "result.title": "計算結果",
    "result.initial": "計算ボタンを押すと、選択した目標のおすすめ編成 TOP 5 が表示されます。",
    "owned.title": "所持カード一覧",
    ...
    "preset.conflict": "リーダーと同じホロメンがメンバーに固定されています。",
