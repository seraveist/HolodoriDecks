...
**v1.2.2** · 홀로라이브 드림스 보유 카드 기반 6인 라이브 편성 시뮬레이터
...
공통 채보는 110초·800개의 균등한 탭 노트·구간을 6등분한 경계의 SP 5개 지점(약 18.33·36.67·55·73.33·91.67초)을 가정합니다. AUTO/Manual 설정은 반영하며, 악곡 미선택의 난이도는 이 공통 기준을 바꾸지 않습니다. 공통 채보 잠재 스코어는 대표 배치를 고르는 내부 기준으로만 사용합니다. 인게임 비교용 유닛스코어와 잠재 유닛스코어를 덮어쓰지 않으며, 실제 곡을 선택하면 그 곡의 시간축과 선택한 계산 목표로 다시 배치합니다.
